...
public class SaidaDAO {
  ...
  public List<SaidaDTO> ListarMedicoes(String Endereco,String OS) throws ClassNotFoundException {
    List<SaidaDTO> lista = new ArrayList<>();
    conn = new ConexaoBD().conectaBD();
    
      try{
        String sql = "SELECT o.LocalObra, o.Tipo , ex.* FROM projetoestoque.execucaoestoque ex INNER JOIN projetoestoque.obras_estoque o ON ex.OS = o.OS";
        
        if (Endereco != null && !Endereco.trim().isEmpty()) {
            sql += " AND o.LocalObra LIKE ?"; // Usa AND para a condição inicial
        }
